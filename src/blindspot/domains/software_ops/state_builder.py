"""Software-ops domain state builder."""
...
def bundle_to_softwareops_state(bundle: DomainStateBundle, seed: int = 42) -> WorldState:
    public: dict = {}
...
def load_softwareops_state(seed: int = 42) -> WorldState:
    ...
    if not report.valid:
        ...
        raise RuntimeError(f"Software-ops fixture validation failed: {errors}")
    return bundle_to_softwareops_state(bundle, seed=seed)
