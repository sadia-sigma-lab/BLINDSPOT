"""Customer service domain state builder."""
...
def bundle_to_cs_state(bundle: DomainStateBundle, seed: int = 42) -> WorldState:
    public: dict = {}
    ...
    # Domain-specific collections: accounts, orders, tickets
...
def load_cs_state(seed: int = 42) -> WorldState:
    ...
    if not report.valid:
        ...
        raise RuntimeError(f"Customer service fixture validation failed: {errors}")
    return bundle_to_cs_state(bundle, seed=seed)
