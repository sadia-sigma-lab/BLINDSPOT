...
class InspectPolicyTool(PythonTool[InspectPolicyArgs, BaseModel]):
    specification = ToolSpecification(
        tool_id=ComponentID(namespace="finance", name="inspect-policy", version="1.0.0"),
        display_name="Inspect Policy",
        description="Return human-readable finance policy information.",
    ...
    def plan_mutations(self, view: ReadOnlyStateView, args: InspectPolicyArgs, context: ToolExecutionContext) -> MutationPlan:
        return MutationPlan()
